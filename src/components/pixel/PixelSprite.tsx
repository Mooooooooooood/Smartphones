...
export const PLAYER_PALETTES: Record<string, SpritePalette> = {
  ...
  // Premium legendary-material tints (bought in the Shop).
  snow: { body: "#cfeeff", hi: "#ffffff", line: "#6f9ec0", accent: "#eafaff" },
  diamond: { body: "#9fe6ff", hi: "#e6fbff", line: "#2f7fb0", accent: "#ffffff" },
  lava: { body: "#ff6a2a", hi: "#ffd05a", line: "#6e1505", accent: "#ffe08a" },
  void: { body: "#7b54d6", hi: "#b89cff", line: "#1a1030", accent: "#e0d0ff" },
};
